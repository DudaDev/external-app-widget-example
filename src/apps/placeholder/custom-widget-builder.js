/**
  Placeholder Widget Builder Integration

  This is the minimal starting point. Copy this folder to src/apps/my-app/
  and replace the props, routes, and UI with your own.
...
// (do NOT include a wrapping function(...) { } yourself):
  ...
  var props = {
    resourceId: data.config.resourceId,
  ...
  fetch('https://YOUR_WORKER_DOMAIN/react-mode?app=placeholder')
    ...
    .then(function (settings) {
      ...
      var scriptSrc = reactMode === 'standalone'
        ? 'https://YOUR_WORKER_DOMAIN/bundles/placeholder/dm-widget.standalone.js'
        : 'https://YOUR_WORKER_DOMAIN/bundles/placeholder/dm-widget.js';
...
// ──────────────|───────────|──────────────────────────────────────────────────────
// resourceId    │ Text      │ (empty) <- ID passed to your backend route
