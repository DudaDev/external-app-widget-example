/**
  Spotify Widget Builder Integration
...
// (do NOT include a wrapping function(...) { } yourself):
  ...
  fetch('https://YOUR_WORKER_DOMAIN/react-mode?app=spotify')
    ...
    .then(function (settings) {
      ...
      var scriptSrc = reactMode === 'standalone'
        ? 'https://YOUR_WORKER_DOMAIN/bundles/spotify/dm-widget.standalone.js'
        : 'https://YOUR_WORKER_DOMAIN/bundles/spotify/dm-widget.js';
...
// ──────────────|───────────|──────────────────────────────────────────────────────
// artistId      │ Text      │ 6qqNVTkY8uBg9cP3Jd7DAH  (Billie Eilish, change to your artist)
